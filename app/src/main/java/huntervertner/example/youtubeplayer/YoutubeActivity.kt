...
const val YOUTUBE_VIDEO_ID = "MBBWVgE0ewk"
const val YOUTUBE_PLAYLIST = "PLDIoUOhQQPlXr63I_vwF9GD8sAKh77dWU"
...
//        layout.addView(button1)
    ...
    private val playbackEventListener = object: YouTubePlayer.PlaybackEventListener{
        override fun onPlaying() {
            Toast.makeText(this@YoutubeActivity, "Good, is playing okay", Toast.LENGTH_SHORT).show()
        }
